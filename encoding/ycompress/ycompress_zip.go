...
func ZipPath(paths, dest string, prefix ...string) error {
	...
	for _, path := range strings.Split(paths, ",") {
		...
		if err := doZipPathWriter(path, yfile.RealPath(dest), zipWriter, prefix...); err != nil {
			return err
		}
	}
	return nil
