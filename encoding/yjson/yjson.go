// Package yjson provides convenient API for JSON/XML/INI/YAML/TOML data handling.
package yjson
...
func (j *Json) convertValue(value interface{}) interface{} {
	...
	default:
		...
		switch kind {
		case reflect.Array:
			return yconv.Interfaces(value)
		case reflect.Slice:
			return yconv.Interfaces(value)
		case reflect.Map:
			return yconv.Map(value)
		case reflect.Struct:
			return yconv.Map(value)
		default:
