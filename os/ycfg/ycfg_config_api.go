...
func (c *Config) GetVar(pattern string, def ...interface{}) *yvar.Var {
	if j := c.getJson(); j != nil {
...
func (c *Config) Getytime(pattern string, format ...string) *ytime.Time {
	if j := c.getJson(); j != nil {
		return j.Getytime(pattern, format...)
	}
	return nil
}
...
func (c *Config) GetJson(pattern string, def ...interface{}) *yjson.Json {
	if j := c.getJson(); j != nil {
...
func (c *Config) GetJsons(pattern string, def ...interface{}) []*yjson.Json {
	if j := c.getJson(); j != nil {
...
func (c *Config) GetJsonMap(pattern string, def ...interface{}) map[string]*yjson.Json {
	if j := c.getJson(); j != nil {
