...
func GetOptVar(name string, def ...string) *yvar.Var {
	Init()
	return yvar.New(GetOpt(name, def...))
}
...
func GetAryvar(index int, def ...string) *yvar.Var {
	Init()
	return yvar.New(GetArg(index, def...))
}
...
func GetWithEnv(key string, def ...interface{}) *yvar.Var {
