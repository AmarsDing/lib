...
type Mutex struct {
	state   *ytype.Int32  // Indicates the state of mutex. -1: writing locked; > 1 reading locked.
	writer  *ytype.Int32  // Pending writer count.
	reader  *ytype.Int32  // Pending reader count.
...
func New() *Mutex {
	return &Mutex{
		state:   ytype.NewInt32(),
		writer:  ytype.NewInt32(),
		reader:  ytype.NewInt32(),
