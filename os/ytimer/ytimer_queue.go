...
type priorityQueue struct {
	...
	latestPriority *ytype.Int64       // latestPriority stores the most priority value of the heap, which is used to check if necessary to call the Pop of heap by Timer.
}
...
func newPriorityQueue() *priorityQueue {
	queue := &priorityQueue{
		...
		latestPriority: ytype.NewInt64(math.MaxInt64),
	}
