...
func (s *StorageMemory) GetSession(id string, ttl time.Duration, data *ymap.StrAnyMap) (*ymap.StrAnyMap, error) {
	return data, nil
}
...
func (s *StorageMemory) SetSession(id string, data *ymap.StrAnyMap, ttl time.Duration) error {
	return nil
}
