...
func New(lruCap ...int) *Cache {
	...
	ytimer.AddSingleton(time.Second, memAdapter.syncEventAndClearExpired)
	return c
}
...
// GetVar retrieves and returns the value of <key> as yvar.Var.
func (c *Cache) GetVar(key interface{}) (*yvar.Var, error) {
	v, err := c.Get(key)
	return yvar.New(v), err
}
