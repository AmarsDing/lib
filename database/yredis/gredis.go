// Package yredis provides convenient client for redis server.
//
// Redis Client.
//
...
// DoVar returns value from Do as yvar.Var.
func (r *Redis) DoVar(commandName string, args ...interface{}) (*yvar.Var, error) {
	return resultToVar(r.Do(commandName, args...))
}

// DoVarWithTimeout returns value from Do as yvar.Var.
// The timeout overrides the read timeout set when dialing the connection.
func (r *Redis) DoVarWithTimeout(timeout time.Duration, commandName string, args ...interface{}) (*yvar.Var, error) {
