...
// GetVar returns a yvar.Var with the value by given <key>.
// The returned yvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVar(key interface{}) *yvar.Var {
	return yvar.New(tree.Get(key))
}

// GetVarOrSet returns a yvar.Var with result from GetVarOrSet.
// The returned yvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSet(key interface{}, value interface{}) *yvar.Var {
	return yvar.New(tree.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a yvar.Var with result from GetOrSetFunc.
// The returned yvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFunc(key interface{}, f func() interface{}) *yvar.Var {
	return yvar.New(tree.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a yvar.Var with result from GetOrSetFuncLock.
// The returned yvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *yvar.Var {
	return yvar.New(tree.GetOrSetFuncLock(key, f))
}
...
func (tree *RedBlackTree) MarshalJSON() ([]byte, error) {
	return json.Marshal(yconv.Map(tree.Map()))
}
...
func (tree *RedBlackTree) UnmarshalJSON(b []byte) error {
	...
	if tree.comparator == nil {
		tree.comparator = yutil.ComparatorString
	}
