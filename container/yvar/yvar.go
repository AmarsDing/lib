// Package yvar provides an universal variable type, like generics.
package yvar
...
func New(value interface{}, safe ...bool) *Var {
	...
	if len(safe) > 0 && !safe[0] {
		v.safe = true
		v.value = ytype.NewInterface(value)
	} else {
		v.value = value
	}
	return &v
...
func (v *Var) Set(value interface{}) (old interface{}) {
	if v.safe {
		if t, ok := v.value.(*ytype.Interface); ok {
			old = t.Set(value)
			return
		}
	}
...
func (v *Var) Bool() bool {
	return yconv.Bool(v.Val())
}

// Int converts and returns <v> as int.
func (v *Var) Int() int {
	return yconv.Int(v.Val())
}

// Int8 converts and returns <v> as int8.
func (v *Var) Int8() int8 {
	return yconv.Int8(v.Val())
}

// Int16 converts and returns <v> as int16.
func (v *Var) Int16() int16 {
	return yconv.Int16(v.Val())
}

// Int32 converts and returns <v> as int32.
func (v *Var) Int32() int32 {
	return yconv.Int32(v.Val())
}

// Int64 converts and returns <v> as int64.
func (v *Var) Int64() int64 {
	return yconv.Int64(v.Val())
}

// Uint converts and returns <v> as uint.
func (v *Var) Uint() uint {
	return yconv.Uint(v.Val())
}

// Uint8 converts and returns <v> as uint8.
func (v *Var) Uint8() uint8 {
	return yconv.Uint8(v.Val())
}

// Uint16 converts and returns <v> as uint16.
func (v *Var) Uint16() uint16 {
	return yconv.Uint16(v.Val())
}

// Uint32 converts and returns <v> as uint32.
func (v *Var) Uint32() uint32 {
	return yconv.Uint32(v.Val())
}

// Uint64 converts and returns <v> as uint64.
func (v *Var) Uint64() uint64 {
	return yconv.Uint64(v.Val())
}

// Float32 converts and returns <v> as float32.
func (v *Var) Float32() float32 {
	return yconv.Float32(v.Val())
}

// Float64 converts and returns <v> as float64.
func (v *Var) Float64() float64 {
	return yconv.Float64(v.Val())
}

// Time converts and returns <v> as time.Time.
// The parameter <format> specifies the format of the time string using ytime,
// eg: Y-m-d H:i:s.
func (v *Var) Time(format ...string) time.Time {
	return yconv.Time(v.Val(), format...)
}

// Duration converts and returns <v> as time.Duration.
// If value of <v> is string, then it uses time.ParseDuration for conversion.
func (v *Var) Duration() time.Duration {
	return yconv.Duration(v.Val())
}

// ytime converts and returns <v> as *ytime.Time.
// The parameter <format> specifies the format of the time string using ytime,
// eg: Y-m-d H:i:s.
func (v *Var) ytime(format ...string) *ytime.Time {
	return yconv.ytime(v.Val(), format...)
}
