...
func (m *IntAnyMap) GetVar(key int) *yvar.Var {
	return yvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSet(key int, value interface{}) *yvar.Var {
	return yvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFunc(key int, f func() interface{}) *yvar.Var {
	return yvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFuncLock(key int, f func() interface{}) *yvar.Var {
...
func (m *IntAnyMap) UnmarshalValue(value interface{}) (err error) {
	...
	switch value.(type) {
	case string, []byte:
		return json.UnmarshalUseNumber(yconv.Bytes(value), &m.data)
	default:
		for k, v := range yconv.Map(value) {
			m.data[yconv.Int(k)] = v
		}
	}
	return
}
