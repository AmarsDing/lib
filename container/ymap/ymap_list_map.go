...
type ListMap struct {
	mu   rwmutex.RWMutex
	data map[interface{}]*ylist.Element
	list *ylist.List
}

type ylistMapNode struct {
	key   interface{}
	value interface{}
}
...
func NewListMap(safe ...bool) *ListMap {
	return &ListMap{
		...
		data: make(map[interface{}]*ylist.Element),
		list: ylist.New(),
	}
}
...
func (m *ListMap) IteratorAsc(f func(key interface{}, value interface{}) bool) {
	...
	defer m.mu.RUnlock()
	if m.list != nil {
		node := (*ylistMapNode)(nil)
		m.list.IteratorAsc(func(e *ylist.Element) bool {
			node = e.Value.(*ylistMapNode)
...
func (m *ListMap) IteratorDesc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		node := (*ylistMapNode)(nil)
		m.list.IteratorDesc(func(e *ylist.Element) bool {
			node = e.Value.(*ylistMapNode)
			return f(node.key, node.value)
		})
	}
...
func (m *ListMap) Clear() {
	m.mu.Lock()
	m.data = make(map[interface{}]*ylist.Element)
	m.list = ylist.New()
	m.mu.Unlock()
}
...
func (m *ListMap) Replace(data map[interface{}]interface{}) {
	...
	for key, value := range data {
		if e, ok := m.data[key]; !ok {
			m.data[key] = m.list.PushBack(&ylistMapNode{key, value})
		} else {
			e.Value = &ylistMapNode{key, value}
		}
	}
	m.mu.Unlock()
}
...
func (m *ListMap) MapStrAny() map[string]interface{} {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *ylist.Element) bool {
			node = e.Value.(*ylistMapNode)
			data[yconv.String(node.key)] = node.value
			return true
		})
	}
	m.mu.RUnlock()
...
func (m *ListMap) Search(key interface{}) (value interface{}, found bool) {
	...
	if m.data != nil {
		if e, ok := m.data[key]; ok {
			value = e.Value.(*ylistMapNode).value
			found = ok
		}
	}
	m.mu.RUnlock()
...
func (m *ListMap) doSetWithLockCheck(key interface{}, value interface{}) interface{} {
	...
	if e, ok := m.data[key]; ok {
		return e.Value.(*ylistMapNode).value
	}
...
func (m *ListMap) GetVar(key interface{}) *yvar.Var {
	return yvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSet(key interface{}, value interface{}) *yvar.Var {
	return yvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFunc(key interface{}, f func() interface{}) *yvar.Var {
	return yvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *yvar.Var {
	return yvar.New(m.GetOrSetFuncLock(key, f))
}
...
func (m *ListMap) Keys() []interface{} {
	...
	if m.list != nil {
		m.list.IteratorAsc(func(e *ylist.Element) bool {
			keys[index] = e.Value.(*ylistMapNode).key
			index++
			return true
		})
	}
...
func (m *ListMap) Values() []interface{} {
	...
	if m.list != nil {
		m.list.IteratorAsc(func(e *ylist.Element) bool {
			values[index] = e.Value.(*ylistMapNode).value
			index++
			return true
		})
	}
...
func (m *ListMap) Merge(other *ListMap) {
	...
	node := (*ylistMapNode)(nil)
	other.list.IteratorAsc(func(e *ylist.Element) bool {
		node = e.Value.(*ylistMapNode)
		if e, ok := m.data[node.key]; !ok {
			m.data[node.key] = m.list.PushBack(&ylistMapNode{node.key, node.value})
		} else {
			e.Value = &ylistMapNode{node.key, node.value}
		}
		return true
	})
}
...
func (m *ListMap) String() string {
	b, _ := m.MarshalJSON()
	return yconv.UnsafeBytesToStr(b)
}

// MarshalJSON implements the interface MarshalJSON for json.Marshal.
func (m *ListMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(yconv.Map(m.Map()))
}
...
func (m *ListMap) UnmarshalValue(value interface{}) (err error) {
	...
	for k, v := range yconv.Map(value) {
		if e, ok := m.data[k]; !ok {
			m.data[k] = m.list.PushBack(&ylistMapNode{k, v})
		} else {
			e.Value = &ylistMapNode{k, v}
		}
	}
	return
}
